...
import { FaCube, FaExchangeAlt, FaExclamationCircle, FaExclamationTriangle, FaInfoCircle, FaQuestionCircle, FaSearch, FaSyncAlt, FaWallet } from 'react-icons/fa';
          ...
          {results.type === 'block' && (
            <div>
              ...
              <div className="detail-item">
                ...
                <div className="detail-content">
                  <div className="detail-label">Block #{results.data.number?.toLocaleString()}</div>
          ...
          {results.type === 'not_found' && (
            <div>
              ...
              <div className="detail-item">
                ...
                <div className="detail-content">
                  <div className="detail-label">No matches found for "{searchQuery}"</div>
                  <div className="detail-value">
          ...
          {results.type === 'error' && (
            <div>
              ...
              <div className="detail-item">
                ...
                <div className="detail-content">
                  <div className="detail-label">An error occurred during search</div>
                  <div className="detail-value">
        ...
        <div className="details-card">
          <div className="detail-item">
            ...
            <div className="detail-content">
              ...
              <div className="detail-value">
                <p>If you're having trouble finding what you're looking for, try:</p>
                <ul>
